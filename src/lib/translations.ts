...
export const translations = {
  pt: {
    ...
    authNameRequired: "Informe seu nome.",
    ...
    dashboardBack: "Voltar ao dashboard",
    ...
    dashboardActiveSites: "Sites ativos",
    dashboardActiveSitesCount: "sites usando o plugin",
    dashboardViewSitesList: "Ver lista",
    ...
    // Sites (PRO)
    sitesNav: "Sites",
    sitesTitle: "Sites cadastrados",
    sitesSub: "Sites onde sua licença PRO foi ativada com o plugin.",
    sitesEmpty: "Nenhum site cadastrado ainda.",
    sitesEmptyHint: "Ao ativar o plugin com sua chave de licença em um site WordPress, ele aparecerá aqui.",
    sitesUrl: "URL",
    sitesName: "Nome",
    sitesFirstSeen: "Primeira ativação",
    sitesLastValidated: "Última validação",
    sitesOpenSite: "Abrir site",
  ...
  en: {
    ...
    dashboardActiveSites: "Active sites",
    dashboardActiveSitesCount: "sites using the plugin",
    dashboardViewSitesList: "View list",
    dashboardGoToPro: "Commenta PRO",
    ...
    // Sites (PRO)
    sitesNav: "Sites",
    sitesTitle: "Registered sites",
    sitesSub: "Sites where your PRO license was activated with the plugin.",
    sitesEmpty: "No sites registered yet.",
    sitesEmptyHint: "When you activate the plugin with your license key on a WordPress site, it will appear here.",
    sitesUrl: "URL",
    sitesName: "Name",
    sitesFirstSeen: "First activated",
    sitesLastValidated: "Last validated",
